...
import './Viblo CV_files/animate.min.css'
import './Viblo CV_files/landing-page.css'
  ...
  return (
    <div className="landing">
      <section className="header">
        <button className="navbar-toggler header__nav--button" type="button" data-toggle="collapse" data-target="#header-menu-button" aria-controls="header-menu-button" aria-expanded="false" aria-label="Toggle navigation" id="header-button-handle">
        ...
        <div className="collapse navbar-collapse header__nav--container" id="header-menu-button">
          <a className="header__nav--container--logo" href="https://cv.viblo.asia/" />
          ...
          <div className="header__nav--container--menu">
            ...
            <div className="menu-item">
              <a className="mobile-menu-item" href="https://accounts.viblo.asia/login?service=cv&amp;continue=https://cv.viblo.asia/">
                Create CV
              </a>
            </div>
            <div className="menu-item">
            ...
            <div className="header__nav--container--language">
              <a className="language-item " href="https://cv.viblo.asia/localization?language=vi" title="Vietnamese">
                Vietnamese
              </a>
              <a className="language-item active" href="https://cv.viblo.asia/localization?language=en" title="English">
                English
              </a>
            </div>
          </div>
        ...
        <div className="header__navbar">
          <div className="container z-index-10 position-relative">
            <a className="navbar-brand header__navbar--logo" href="https://cv.viblo.asia/" />
              ...
              <div className="header__nav--desktop w-100">
                <div className="d-flex w-100">
                  ...
                  <div className="header__nav--desktop__right">
                    <a className="landing-button button-bg-white" href="https://accounts.viblo.asia/login?service=cv&amp;continue=https://cv.viblo.asia/">
                      Create CV
                    </a>
                    <div className="dropdown-language">
                      <a className="dropdown-toggle language" href="https://cv.viblo.asia/landing#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img className="rounded-circle" src="./Viblo CV_files/en.png" />
                        <span className="pr-3">English</span>
                      </a>
                      <div className="dropdown-menu dropdown-container">
                        <a className="dropdown-item" href="https://cv.viblo.asia/localization?language=vi" title="Vietnamese">
                          Vietnamese
                        </a>
                        <div className="dropdown-divider" />
                        <a className="dropdown-item" href="https://cv.viblo.asia/localization?language=en" title="English">
                          English
                        </a>
                      </div>
                    </div>
                    <div className="bg-right" style={{ display: 'none' }} />
                  </div>
                </div>
              </div>
            </nav>
        ...
        <div className="container header__content z-index-10 position-relative">
          <div className="header__content__left wow bounceInDown animated" data-wow-duration="1s" style={{ visibility: 'hidden', animationDuration: '1s', animationName: 'bounceInDown' }}>
            ...
            <div
              ...
              data-wow-delay="0.5s"
              style={{
                visibility: 'visible', animationDuration: '1.5s', animationName: 'fadeInUp', animationDelay: '0.5s',
              }}
            >
              Pick a resume template below that represents your skills and work experience the best.
            </div>
            <a className="landing-button button-bg-blue mt-5" href="https://accounts.viblo.asia/login?service=cv&amp;continue=https://cv.viblo.asia/">
              Create CV
            </a>
          </div>
          <div className="header__content__right">
            <img src="./Viblo CV_files/bg-header.png" />
          </div>
        </div>
      </section>
        ...
        <div className="introduction__content z-index-10 position-relative d-flex justify-content-center">
          <div className="introduction__content--background d-flex align-items-center">
            <div className="introduction__left">
              <img src="./Viblo CV_files/item-introduction.png" />
            </div>
            <div className="introduction__right wow bounceInRight animated" data-wow-duration="1.5s" style={{ visibility: 'visible', animationDuration: '1.5s', animationName: 'bounceInRight' }}>
              ...
              <div className="usable__item">
                <div className="icon">
                  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="
                    <path d="M39.5819 28.4419C39.5819 29.1039 39.0453 29.6405 38.3833 29.6405H26.3594V17.6167C26.3594 16.9546 26.896 16.418 27.5581 16.418C28.2201 16.418 28.7568 16.9546 28.7568 17.6167V27.2432H38.3833C39.0453 27.2432 39.5819 27.7799 39.5819 28.4419Z" fill="#B5BCC6" />
                  </svg>
                </div>
                <div className="text">
        ...
        <div className="diversity__content">
          <div className="container">
            ...
            <div className="diversity__main">
              <div className="diversity__left wow fadeInDown" data-wow-duration="2s" style={{ visibility: 'hidden', animationDuration: '2s', animationName: 'none' }}>
                <div className="diversity__item d-flex align-items-center">
                  <img src="./Viblo CV_files/icon-tick.png" />
                  <div className="text">
              ...
              <div className="diversity__right">
                <img src="./Viblo CV_files/bg-diversity-right.png" />
              </div>
            </div>
            <div />
          </div>
      ...
      <section className="free">
        <div className="container">
          <div className="free__content">
            ...
            <div
              className="free__list-items wow bounceIn"
              data-wow-duration="1.5s"
              data-wow-delay="0.5s"
              style={{
                visibility: 'hidden', animationDuration: '1.5s', animationDelay: '0.5s', animationName: 'none',
          ...
          <div className="container">
            ...
            <div className="privacy__main">
              <div className="privacy__left">
                <img src="./Viblo CV_files/bg-privacy-left.png" />
              </div>
              <div
                className="privacy__right wow bounceInRight"
                data-wow-duration="1.5s"
                data-wow-delay="0.5s"
                style={{
                  visibility: 'hidden', animationDuration: '1.5s', animationDelay: '0.5s', animationName: 'none',
        ...
        <div className="slogan-footer__content d-flex">
          <div className="slogan-footer__left">
            <div className="text">
              ...
              <span className="slogan-text"> makes your life EASIER</span>
              <div className="slogan-text">whereas a Bad CV makes it a disaster</div>
            </div>
            <div className="d-flex justify-content-end mt-4">
              <a className="landing-button button-bg-blue" href="https://accounts.viblo.asia/login?service=cv&amp;continue=https://cv.viblo.asia/">
                Create CV
              </a>
            </div>
          </div>
          <div className="slogan-footer__right">
            <img src="./Viblo CV_files/bg-slogan-right.png" />
          </div>
        </div>
      </section>
      ...
      <a id="back-to-top" href="https://cv.viblo.asia/landing#" className="back-to-top" role="button" title="Click to return on the top page">
        <svg width="12" height="22" viewBox="0 0 12 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0.165441 5.56606C-0.0628625 5.80489 -0.0538623 6.18361 0.186141 6.41109C0.426144 6.63886 0.805949 6.62929 1.03455 6.39046L5.39991 1.80454L5.39991 21.4022C5.39991 21.7322 5.66872 22 5.99992 22C6.33112 22 6.59993 21.7322 6.59993 21.4022L6.59993 1.82367L10.9656 6.39046C11.1942 6.62959 11.574 6.63886 11.814 6.41109C11.9376 6.29361 12 6.13609 12 5.97826C12 5.83 11.9451 5.68174 11.8344 5.56606L6.84833 0.350326C6.62183 0.124347 6.32062 -2.76283e-07 5.99992 -2.62265e-07C5.67921 -2.48246e-07 5.37801 0.124347 5.14131 0.360788L0.165441 5.56606Z" fill="white" />
        </svg>
      </a>
    </div>
  )
